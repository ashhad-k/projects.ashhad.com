(function () {
  ...
  function addChatWidget() {
    ...
    const chatWidgetHTML = `
        <div id="chat-widget" class="chat-container eid-toggle-chatbot">
            ...
            <div class="chat-header" id="chat-header">              
               ...
               <img class="chatbot-header-logo" src="./images/logo-dark.svg" alt="chat bot">
              ...
              <img id="fullScreenToggle" class="chatbot-full-img" src="./images/dark/resize.svg" alt="chat bot" title="Resize">
               ...
               <img  id="modeToggle" class="chatbot-mood-img" src="./images/dark/moon.svg" alt="Change Mode" title="Mode: Lite | Dark">
               </div>
            </div>
    ...
    <div class="ai-tags"> 
     <div onclick="handleClick(this)">What is StarklyAI?</div>
...
<div>
  ...
  function updateDynamicMessage() {
    var messages = ["Talk to StarklyAI Agent", "Contact Us", "Schedule a Callback", "Learn about AI Agents"];
  ...
  function setUpEventListeners(connection, clientId) {
    ...
    document.getElementById("eidChatPanel").addEventListener("click", () => {
        displaySystemMessage("How can I help?");
        const chatWidget = document.getElementById("chat-widget");
    ...
    const eidChatPanel = document.getElementById('eidChatPanel');
    // eidChatPanel.addEventListener('click', function(event) {
     
    //     // Your custom logic here
        
 
    //     // Example: Toggle chat visibility or perform another action
    //    document.getElementById('chat-widget').classList.toggle('eid-toggle-chatbot');
    //    displaySystemMessage("How can I help?");
    // });
  ...
  function displaySystemMessage(message) {
    const time = new Date().toLocaleTimeString();
    const messageContent = `${message}`;
    const msg = createMessageElement('StarklyAI', messageContent, 'system-message', './images/logo-lite.svg', time, 'system');
    const chatMessages = document.getElementById("chat-messages");
    chatMessages.appendChild(msg);
    scrollToBottom(chatMessages);
  }

...
//Your E-mail
$your_email = 'ashhad4u@gmail.com';

//Default Subject if 'subject' field not specified
$default_subject = 'ZIL Website Contact Form';
...
if(isset($_POST['message']) and isset($_POST['name'])) {
	if(!empty($_POST['company_name']))
		$sender_name  = stripslashes(strip_tags(trim($_POST['company_name'])));
	
	if(!empty($_POST['name']))
		$sender_name  = stripslashes(strip_tags(trim($_POST['name'])));
	
	if(!empty($_POST['designation']))
		$sender_name  = stripslashes(strip_tags(trim($_POST['designation'])));

...
jQuery(document).ready(function($) 
{
	...
	.on('mouseup',f_up)
	.on('mousemove',f_move)
	.on('touchstart',function(e){if(e.originalEvent.touches[0]){e.screenX=e.originalEvent.touches[0].screenX;e.screenY=e.originalEvent.touches[0].screenY;}f_down(e);})
	.on('touchend touchcancel',f_up)
	.on('touchmove',function(e){if(e.originalEvent.touches[0]){e.screenX=e.originalEvent.touches[0].screenX;e.screenY=e.originalEvent.touches[0].screenY;}f_move(e);})
	...
	ddo.on('click', 'a', function(e){ e.preventDefault(); });
});
